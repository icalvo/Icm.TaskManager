define(
['knockout', 'app/task/task.viewmodel', 'app/task/reminder.viewmodel', 'app/metadata/api', 'moment', /* Non-exporting: */ 'app/infrastructure/ajaxPrefilters'],
function (ko, TaskViewModel, ReminderViewModel, taskManagerApi, moment) {
    return function TaskListViewModel(app) {
        var self = this;
