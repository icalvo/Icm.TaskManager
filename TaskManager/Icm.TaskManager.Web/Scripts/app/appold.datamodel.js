function AppDataModel() {
    var self = this,
        rootUrl = "http://localhost:53187",
        // Routes
        addExternalLoginUrl = rootUrl + "/api/Account/AddExternalLogin",
        changePasswordUrl = rootUrl + "/api/Account/changePassword",
        loginUrl = "/Token",
        logoutUrl = rootUrl + "/api/Account/Logout",
        registerUrl = rootUrl + "/api/Account/Register",
        registerExternalUrl = rootUrl + "/api/Account/RegisterExternal",
        removeLoginUrl = rootUrl + "/api/Account/RemoveLogin",
        setPasswordUrl = rootUrl + "/api/Account/setPassword",
        siteUrl = "/",
        userInfoUrl = rootUrl + "/api/Account/UserInfo";

    // Route operations
    function externalLoginsUrl(returnUrl, generateState) {
        return rootUrl + "/api/Account/ExternalLogins?returnUrl=" + (encodeURIComponent(returnUrl)) +
            "&generateState=" + (generateState ? "true" : "false");
    }

    function manageInfoUrl(returnUrl, generateState) {
        return rootUrl + "/api/Account/ManageInfo?returnUrl=" + (encodeURIComponent(returnUrl)) +
            "&generateState=" + (generateState ? "true" : "false");
    }
